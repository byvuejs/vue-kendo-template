  ...
  <div class="container-fluid">
    ...
    <div class="row my-4">
          ...
          <fieldset>
            ...
            <div :style="{ marginTop: '1rem' }">
              <label class="k-form-field">
                ...
                <label class="k-checkbox-label" for="twoFactor">Enable two-factor authentication</label>
              </label>
            </div>
          </fieldset>
      ...
      <div class="col-12 col-lg-3 mt-3 mt-lg-0">
        ...
        <p>
          For documentation and demos of the many form-friendly components please visit their documentation (
          <a
            href="https://www.telerik.com/kendo-vue-ui/components/dateinputs/?utm_medium=cpm&utm_source=vscode-app&utm_campaign=kendo-ui-vue-trial-dateinputs"
          >Date Inputs</a>,
          <a
            href="https://www.telerik.com/kendo-vue-ui/components/dropdowns/?utm_medium=cpm&utm_source=vscode-app&utm_campaign=kendo-ui-vue-trial-dropdowns"
          >DropDowns</a>,
          <a
            href="https://www.telerik.com/kendo-vue-ui/components/inputs/?utm_medium=cpm&utm_source=vscode-app&utm_campaign=kendo-ui-vue-trial-inputs"
          >Inputs</a> etc).
        </p>
      </div>
    </div>
