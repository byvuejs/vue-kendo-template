  ...
  <div class="container-fluid">
    <div class="row my-4">
      ...
      <div class="col-12 col-lg-3 mt-3 mt-lg-0">
        ...
        <p>
          For documentation and demos of all available Chart types (Bar, Line, Donut, Sparkline, StockChart etc), please visit the
          <a
            href="https://www.telerik.com/kendo-vue-ui/components/charts/?utm_medium=cpm&utm_source=vscode-app&utm_campaign=kendo-ui-vue-trial-charts"
          >KendoVue Chart documentation page.</a>
        </p>
      </div>
    </div>
  </div>
